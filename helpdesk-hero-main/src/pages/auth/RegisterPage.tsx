...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState<FormState>({ fullName: "", email: "", password: "", confirmPassword: "", role: "USER" });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(async () => {
      try {
        await registerAccount(form.fullName.trim(), form.email.trim(), form.password, form.role);
        toast({
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 rounded-lg border border-input bg-background text-foreground text-sm outline-none transition-colors focus:ring-2 focus:ring-primary/30 focus:border-primary"
              >
